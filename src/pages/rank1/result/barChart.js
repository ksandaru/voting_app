...
import { Container, Paper, Grid, Card, CardHeader, CardContent, Typography, ButtonGroup } from '@material-ui/core';
import { Doughnut } from 'react-chartjs-2';
import { Col, Overlay, Row, Button,Jumbotron } from 'react-bootstrap';
...
export default class barChart extends Component {
    ...
    <div className="home_content">   
     ...
     <div class="wrapper">
        ...
        <preHeader class="pre-head">
            <HeaderBar/>
        </preHeader>

        <article class="content"  id="PartyResultView">
             {this.openMap()}
